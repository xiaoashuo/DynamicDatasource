...
import com.lovecyy.dynamic.pojo.BasePojo;
...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.lovecyy.dynamic.annotation.DataScope)")
  ...
  /*      SysUser currentUser = ShiroUtils.getSysUser();
        ...
        dataScopeFilter(joinPoint, new User(), controllerDataScope.tableAlias());
...
*/
        ...
        {
            BasePojo baseEntity = (BasePojo) joinPoint.getArgs()[0];
           // baseEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
            Map<String, Object> params = baseEntity.getParams();
            params.put(DATA_SCOPE,sqlString.toString());
